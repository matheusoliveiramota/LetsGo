...
namespace IdentityServer4.Quickstart.UI
{
    ...
    public class AccountController : Controller
    {
        ...
        /// </summary>
        [HttpGet]
        public async Task<IActionResult> New(LoginViewModel loginViewModel)
        {
            return View(new NewUserInputModel { ReturnUrl = loginViewModel.ReturnUrl });
        }

        [HttpPost]
        public async Task<IActionResult> New(NewUserInputModel newUser)
        {
            if(TestUsers.Users.Where(u => u.Username == newUser.Username).Count() > 0)
            {
